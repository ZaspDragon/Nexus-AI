      ...
      <section className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
          ...
          header={
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-400">Labor utilization should stay near target without starving any team.</p>
              </div>
        ...
        >
          <div className="space-y-5">
            {selectedWarehouse.laborSegments.map((segment) => (
        ...
        >
          <div className="space-y-3">
            {selectedWarehouse.workers.map((worker) => (
