...
import { inventoryZones, reportHighlights } from '../data/warehouseDemo';

export const InventoryPage = () => (
  <div className="space-y-6">
    <PageHeader
      eyebrow="Inventory"
      title="Cycle counts, zone variance, and accuracy risk"
    ...
    <section className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
      ...
      <SurfaceCard
        header={
          <div>
            <h2 className="text-xl font-semibold text-white">Inventory rules of the shift</h2>
            <p className="mt-1 text-sm text-slate-400">Targets operators and supervisors should know by heart.</p>
          </div>
        }
      >
